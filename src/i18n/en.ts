...
export const en = {
  ...
  'home.noRoutines': 'No routines yet — create one from the Train tab.',
  ...
  'workout.repeatLast': 'Log the rest',
  'workout.repeatLastHint': 'Every empty box takes the grey number showing in it',
  'workout.logSet': 'Log',
  ...
  'workout.exerciseActions': 'Exercise options',
  'workout.supersetHint': 'Pair with the exercise above — no rest between them.',
  'workout.removeSet': 'Remove last set',
  'workout.rest': 'Rest',
  ...
  'nutrition.fat': 'Fat',
  // One letter each, for the macro line on a list row where the full words
  // would not fit. Arabic gets its own initials rather than P/C/F.
  ...
  'nutrition.days7': '7 days',
  'nutrition.days30': '30 days',
  'nutrition.days90': '90 days',
  'nutrition.average': 'Average per logged day',
  'nutrition.loggedDays': '{count} of {total} days logged',
  'nutrition.onTargetDays': '{count} of {total} logged days landed on your calorie target.',
  'nutrition.caloriesPerDay': 'Calories per day',
  'nutrition.proteinPerDay': 'Protein per day',
  'nutrition.everyDay': 'Day by day',
  'nutrition.noHistory': 'Nothing logged in this period',
  'nutrition.noHistoryHint': 'Log what you eat and every day shows up here — calories, protein, carbs and fat.',
  ...
  'exercises.defaultReps': 'Default rep range',
  'exercises.defaultHold': 'Default hold time',
  'exercises.defaultRepsHint': 'Every routine that picks this exercise up starts from here.',
