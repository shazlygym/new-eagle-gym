              ...
              <li key={routine.id} className="card overflow-hidden">
                <div className="flex items-center gap-2 p-4">
                  ...
                  <Link
                    ...
                    className="rounded-xl bg-dark-600 p-2.5 text-dark-100 active:bg-dark-500"
                  >
                    <Pencil size={16} />
                  </Link>
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-xl bg-gold-500 px-3.5 py-2.5
                               text-sm font-semibold text-dark-900 active:scale-95 transition-transform"
                  >
